...
class hijabviewer extends StatefulWidget {
  
  const hijabviewer({Key? key, required this.product}) : super(key: key);
  final Product product;

  @override
  State<hijabviewer> createState() => _hijabviewerState();
}

class _hijabviewerState extends State<hijabviewer> {
